...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex min-h-10 items-center justify-center rounded-lg border border-white/10 bg-slate-950/60 p-1 text-slate-400",
      className,
    )}
    {...props}
  />
